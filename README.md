...
Reference the WslcWrapper.csproj from the [git repo](https://github.com/silentorbit/wslc-wrapper) or use the NuGet package [SilentOrbit.WSLC](https://www.nuget.org/packages/SilentOrbit.WSLC).
